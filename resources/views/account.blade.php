...
@section('content')
    <div class="account-container">
        <header class="flex justify-between items-center mb-8">
            ...
            <x-auth-buttons :showDashboard="true" :showAccount="false" :showLogout="true" />
        </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-medium mb-2 flex justify-between">Account Details
                        ...
                        <div id="editAccountModal"
                            class="hidden fixed inset-0 modal-background flex items-center justify-center p-4 z-50">
                            <form id="timezoneForm" method="POST" action="{{ route('account.update-timezone') }}"
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p class="text-sm text-gray-600">Last login:
                        {{ $user->updated_at->setTimezone($user->timezone)->format('M d, Y g:i A') }}
                    </p>
                </div>
            </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xs text-gray-400">
                                {{ $user->created_at->setTimezone($user->timezone)->format('M d, Y g:i A') }}
                            </p>
                        </div>
                    </div>
                </div>
